...
export default function SpendingHealthScreen() {
  ...
  const cfg =
    RISK_CONFIG[riskLevel as keyof typeof RISK_CONFIG] ||
    RISK_CONFIG.medium;

  // ── FIXED CATEGORY BREAKDOWN ────────────────────────────
  const breakdown = (() => {
    const raw = (insights as any)?.categoryBreakdown ?? {};
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            {insights?.prediction ||
              "Your spending patterns are stable. You're likely to stay within budget if you maintain this pace."}
          </Text>
        </View>
      </ScrollView>
    </SafeAreaView>
